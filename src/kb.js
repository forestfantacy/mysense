...
const Api = require('./kb/api').default;
...
IndexAutocompleteComponent.prototype = _.create(
  autocomplete_engine.ListComponent.prototype, { 'constructor': IndexAutocompleteComponent });
...
TypeAutocompleteComponent.prototype = _.create(
  autocomplete_engine.ListComponent.prototype, { 'constructor': TypeAutocompleteComponent });
...
FieldAutocompleteComponent.prototype = _.create(
  autocomplete_engine.ListComponent.prototype, { 'constructor': FieldAutocompleteComponent });
...
IdAutocompleteComponent.prototype = _.create(
  autocomplete_engine.SharedComponent.prototype, { 'constructor': IdAutocompleteComponent });
...
export function setActiveApi() {
  debugger;
  let api = loadApisFromJson(window.ES5DATA || {});
  //loadApisFromJson(window.ES5DATA || {});
  // setActiveApi(loadApisFromJson(window.ES5DATA || {}));
  // if (_.isString(api)) {
  //   $.ajax({
