require('ace');
require('aceroot/ext-searchbox');
let Autocomplete = require('./autocomplete').default;
let SenseEditor = require('./sense_editor/editor').default;
let settings = require('./settings');
let utils = require('./utils');
let es = require('./es');
let history = require('./history');
import input_resize from './input_resize'
// import { uiModules } from 'ui/modules';

let input;
export function initializeInput($el, $actionsEl, $copyAsCurlEl) {
